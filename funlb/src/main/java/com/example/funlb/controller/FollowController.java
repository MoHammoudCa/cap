...
public class FollowController {
    ...
    public ResponseEntity<List<UUID>> getFollowersIds(@PathVariable UUID userId) {
        List<UUID> followersIds = followService.getFollowersIds(userId);
        return ResponseEntity.ok(followersIds);
    }
